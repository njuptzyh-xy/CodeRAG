...
class GraphRAG:
    ...
    def __init__(self, retriever: Retriever, llm: LLMInterface, prompt_template: RagTemplate = RagTemplate()):
        try:
    ...
    def search(
        ...
        return prompt, message_history, self.prompt_template.system_instructions
