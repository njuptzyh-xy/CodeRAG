...
"""
        ...
        # 软件战术分析提示词模板
        self.TACTICS_PROMPT = """
the software is {software_name} , path is {software_path}
...
请从以下几个方面分析该软件涉及的战术技术:

以下是 MITRE ATT&CK 框架的完整战术列表：
...
"""
    ...
    def get_summary_prompt(self, readme_content: str, file_tree: str) -> str:
        """获取项目摘要分析prompt"""
    ...
    def get_tactics_prompt(self, summary: str, file_code: str, software_name: str, software_path: str) -> str:
        """获取战术分析prompt"""
        return self.TACTICS_PROMPT.format(
    ...
    def get_technique_prompt(self, code_chunks: List[Dict[str, Any]], software_name: str, 
                           software_tactics: Dict[str, Any], file_path: str) -> str:
        """获取技术分析prompt"""
        # 格式化代码块
        chunks_json = json.dumps(code_chunks, ensure_ascii=False, indent=2)
        tactics_json = json.dumps(software_tactics, ensure_ascii=False, indent=2)
        
        return self.TECHNIQUE_PROMPT.format(
            code_chunks=chunks_json,
            software_name=software_name,
            software_tactics=tactics_json,
            file_path=file_path,
